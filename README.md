...
[Live app](https://volta-npo.github.io/crm-lite-migrator/) · [Report an issue](https://github.com/volta-npo/crm-lite-migrator/issues) · [Volta](https://voltanpo.org)
...
```bash
git clone https://github.com/volta-npo/crm-lite-migrator.git
