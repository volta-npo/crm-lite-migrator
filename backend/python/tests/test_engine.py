...
from crm_lite_migrator_backend.engine import DOMAIN_ROWS, PRODUCT_SLUG, build_release_packet, summarize_rows
...
class ServerModuleTests(unittest.TestCase):
    def test_health_handler_exists(self):
        from crm_lite_migrator_backend.server import Handler
