export const v3 = {
    ...
    "capabilities": [
        "Domain-specific workbench: CRM Migration Workbench",
        "Operational table: Contact cleanup grid",
    ...
    "releaseChecklist": [
        ...
        "Cleanliness Score reaches production threshold",
        "Duplicate Risk is documented with evidence",
        "Consent Coverage has no unresolved blocker",
        "Clean CRM CSV verified",
        "Rejected rows report verified",
        "Mapping doc verified"
    ],
    "operations": [
